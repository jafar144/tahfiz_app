...
class _SelectAsatidzPageState extends State<SelectAsatidzPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Pilih Asatidz'),
      ),
      body: Column(
        children: [
          Padding(
              ...
              builder: (context, state) {
                      ...
                      return Skeletonizer(
                        ...
                        child: ListView.separated(
                          ...
                          itemCount: dataList.length + (state is AsatidzLoaded && state.isFetchingMore ? 1 : 0),
                          ...
                          itemBuilder: (context, index) {
                            ...
                            final isDisabled = widget.disabledIds.contains(asatidz.id);
                            ...
                            return ListTile(
                              ...
                              leading: CircleAvatar(
                                ...
                                child: Text(
                                  asatidz.name[0], 
                                  style: TextStyle(color: isSelected && !isDisabled ? Colors.white : Colors.black54)
                                ),
                              ),
                              title: Text(
                                asatidz.name, 
                              ...
                              subtitle: Text(
                                isDisabled ? '${asatidz.nis} (Tidak Tersedia)' : asatidz.nis,
                                style: TextStyle(color: isDisabled ? Colors.red.shade300 : null),
                              ),
                              shape: RoundedRectangleBorder(
                                borderRadius: BorderRadius.circular(12),
                                side: BorderSide(color: isSelected && !isDisabled ? Colors.blue : Colors.grey.shade200),
                              ),
                              ...
                              trailing: isSelected && !isDisabled 
                                  ...
                                  : (isDisabled ? const Icon(Icons.block, color: Colors.grey) : null),
                            );
                          },
                        ),
                      );
